...
let cc = Config.sessionName.replace(/KING-MD;;;/g, "").replace(/KING-MD;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect BLACK md session id too
...
app.listen(port, () => console.log(`ELSA MD Server listening on port http://localhost:${port}!`));
