...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? '𝐏𝐀𝐓𝐂𝐇𝐄𝐑𝐀❄️&♡:ابوهايف' : process.env.OWNER_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '𝐏𝐀𝐓𝐂𝐇𝐄𝐑𝐀❄️&♡:ابوهايف' : process.env.PACK_INFO.split(";")[1],
